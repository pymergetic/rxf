...
static void exit_qemu(rxf_u32 ok) { static rxf_u64 b[2]; b[0]=ok?0x20026:0x20023; register rxf_u64 x0 __asm__("x0")=0x20; register void *x1 __asm__("x1")=b; __asm__ volatile("hlt #0xf000"::"r"(x0),"r"(x1):"memory"); for(;;)__asm__ volatile("wfe"); }
